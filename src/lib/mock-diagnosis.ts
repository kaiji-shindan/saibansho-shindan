...
function buildMockProfile(username: string, seed: number): ProfileData {
  ...
  return {
    ...
    bioEntities: {
      urls: [
        {
          url: "https://t.co/sample01",
          expandedUrl: "https://example.com/portfolio",
          displayUrl: "example.com/portfolio",
        },
      ],
      hashtags: ["趣味垢", "雑談"],
      mentions: [],
    ...
    pinnedTweet: {
      id: "mock_pinned",
      text: "プロフ見てくれてありがとうございます。気軽に絡んでください。フォロー前にひと言いただけると嬉しいです。",
    ...
    evidence: ([
      {
        ...
        emotion: "anger",
        metrics: { likes: 47, rt: 12, reply: 8, impressions: 18420, bookmarks: 3 },
        source: "Twitter Web App",
        possiblySensitive: true,
        contextTopics: [
          { domain: "Person", entity: "ターゲット個人" },
          { domain: "Topic", entity: "中傷" },
        ],
      },
      {
        tweet_id: "mock_002",
        ...
        emotion: "threat",
        metrics: { likes: 8, rt: 1, reply: 3, impressions: 1240, bookmarks: 1 },
        source: "Twitter for iPhone",
        referencedTweet: {
          type: "replied_to",
          text: "ふざけんな、二度と関わるなって言っただろ。",
          authorUsername: "victim_acc",
          authorName: "被害者アカ",
          likes: 2,
          rt: 0,
        },
      },
      {
        ...
        emotion: "contempt",
        metrics: { likes: 23, rt: 5, reply: 4, impressions: 6510 },
        source: "Twitter for Android",
        media: [
          {
            type: "photo",
            previewImageUrl: "https://placehold.co/600x400/eee/aaa?text=screenshot",
            altText: "対象アカウントのプロフィール画像のスクリーンショット",
          },
        ],
      },
      {
        tweet_id: "mock_004",
        text: "◯◯の本名△△で、△△大学の3年生らしいよ。インスタは @xxxxx だって。本人気付かないだろうけど一応共有しとくね。あと過去の卒アルも見つけたから後で貼る。",
        ...
        emotion: "contempt",
        metrics: { likes: 31, rt: 9, reply: 6, impressions: 8830, bookmarks: 12 },
        isLongForm: true,
        source: "Twitter Web App",
        contextTopics: [
          { domain: "Topic", entity: "個人情報" },
        ],
      },
      {
        tweet_id: "mock_005",
        ...
        emotion: "mockery",
        metrics: { likes: 19, rt: 4, reply: 2, impressions: 4120 },
        source: "Twitter for iPhone",
        referencedTweet: {
          type: "quoted",
          text: "◯◯さん、新しい職場で頑張ってるみたいだね。応援してます。",
          authorUsername: "neutral_acc",
          authorName: "知人A",
          likes: 12,
          rt: 1,
        },
      },
      {
        ...
        emotion: "mockery",
        metrics: { likes: 6, rt: 0, reply: 1, impressions: 720 },
        source: "Twitter for iPhone",
      },
